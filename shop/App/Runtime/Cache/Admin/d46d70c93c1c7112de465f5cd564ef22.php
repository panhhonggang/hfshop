...
<body>
    ...
    <div class="row-fluid" id="main">
        <div class="span8 offset2">
            <form class="form-horizontal " action="/gz16/object02/Admin/Role/saveNode" method="post">
                <h3>分配节点</h3>
                <input type="hidden" name="id" value="<?php echo ($roleInfo["id"]); ?>">
                <div class="control-group">
                    当前为<font color="red"size="5px"> <?php echo ($roleInfo["name"]); ?></font>分配节点
                </div>

                <div class="control-group">
                    <div class="controls">
                        <?php if(is_array($nodelist)): foreach($nodelist as $key=>$vo): echo ($vo["name"]); ?> <input type="checkbox" name="nid[]" <?php if(in_array($vo['id'],$nids)): ?>checked<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><br><?php endforeach; endif; ?>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        ...
                        <button class="btn btn-large btn-primary form-submit" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分配节点&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </div>
                </div>
            </form>
        </div>
