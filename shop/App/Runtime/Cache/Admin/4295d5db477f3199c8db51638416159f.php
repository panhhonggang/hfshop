...
<body>
    ...
    <div class="row-fluid" id="main">
        <div class="span8 offset2">
            <form class="form-search fr" action="/shop/Admin/User/index" method="get">
                <input type="text" name="admin_name" class="input-medium" placeholder="Name">
                <!-- <select name="sex">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <a href="/shop/Admin/User/sendMail/id/<?php echo ($vo["id"]); ?>">发送邮件</a>
                            <a href="/shop/Admin/User/edit/id/<?php echo ($vo["id"]); ?>">编辑</a>
                            <a href="/shop/Admin/User/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                        </td>
